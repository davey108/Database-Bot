...
function printCommandTable(){
    var command = "`$help				    -print out all commands\n" +
...
function playTicTacToe(row, col, userID, channelID){
    ...
    var tGame = evalInstanceT(userID, channelID);
...
function winGame(userID,channelID){
   database.insertCreditBot(userID,channelID,5);
   return "You win!\n";
}

//Calls functions to update the DB
function loseGame(userID,channelID){
    database.insertCreditBot(userID,channelID,-5);
    return;
}
...
//Bot calls iteself in slots game
botID = '426481228112330752'
